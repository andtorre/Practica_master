namespace waveana
{
  ...
  private:
    ...
    double AverageAmplitudeRange = 0.0;
    double AverageAmplitudeRange_counter = 0;
  ...
  public:
    ...
    // int PedRange/*# of samples to compute pedestal*/, int TriggerRange/*Range to compute the trigger charge*/, double ConversionFactor, double range1, double range2, double FixedPedestal=0, double t1=16e-9, double t2=112e-9, double t3=3008e-6, double adctt=3800)
    {
      ...
      */
      ...
      AverageAmplitudeRange = -rangemin0 / AverageAmplitudeRange_counter + PedestalMean;
      ...
      if(MaxAmplitude_Range<2*PedestalSTD) ispedestalRange=true;
      if(PedestalStatus && (MaxAmplitude<2*PedestalSTD)) ispedestal=true;
    ...
    void Print()
    {
      ...
      std::cout << "\tisPedestalRange: " << ispedestalRange << std::endl;
      std::cout << "\tisPedestal: " << ispedestal << std::endl;
      ...
      std::cout << "\tQPeak: " << Charge_MaxPeakRange << std::endl;
      std::cout << "\tQPeakRange1: " << QFixed_ranges[1] << std::endl;
      ...
      std::cout << "\tAverageAmplitudeRange: " << AverageAmplitudeRange << std::endl;
    ...
    vector<double> getQPeak_ranges() { return QPeak_ranges; }
    ...
    bool getIsPedestalRange() {return ispedestalRange;}
    bool getIsPedestal() {return ispedestal;}

    double getS2Charge() { return S2Charge; }
    double getS2AverageAmplitude() { return S2AverageAmplitude; }
    double getAverageAmplitudeRange() { return AverageAmplitudeRange; }
